...
<body class="font-sans bg-gray-100">
    ...
    <section id="home" class="relative py-32 bg-cover bg-center" style="background-image: url('truck.jpg');">
        ...
        <div class="container mx-auto text-center relative z-10">
            <h1 class="text-5xl font-extrabold mb-4 text-white animate__animated animate__fadeIn">Your Trusted Trucking Partner</h1>
            <p class="text-xl mb-8 text-white animate__animated animate__fadeIn animate__delay-1s">Delivering excellence, on time, every time.</p>
    ...
    <section id="about-us" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <img src="trucker.jpg" alt="About Us" class="rounded-lg shadow-lg">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <div class="flex items-center mb-4">
                        <img src="https://via.placeholder.com/50" alt="John Doe" class="rounded-full mr-4">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <div class="flex items-center mb-4">
                        <img src="https://via.placeholder.com/50" alt="Jane Smith" class="rounded-full mr-4">
